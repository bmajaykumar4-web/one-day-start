...
export function HeartRateECG() {
  return (
    <div className="flex flex-col items-center justify-center py-8 w-full max-w-lg mx-auto">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 502.98 108.61"
        className="w-full h-auto max-h-[80px] overflow-visible drop-shadow-[0_2px_10px_rgba(242,167,187,0.35)]"
      >
        {/* Beating Heart Path */}
        <path
          className="ecg-heart"
      ...
      <motion.p
        ...
        animate={{ opacity: 0.8 }}
        transition={{ delay: 1 }}
        className="mt-4 font-hand text-xl text-[color:var(--rose)]"
      >
